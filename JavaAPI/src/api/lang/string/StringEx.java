...
public class StringEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("문자열을 3번째 인덱스 부터 찾은 위치" + str.indexOf("l", 3));
		...
		String r2 = b.replace("문자", "word"); //타겟 문자, 바꿀 문자
		...
		System.out.println("cba".compareTo("abc"));
		...
		//문자열 자르기 toCharArray 캐릭터 배열로 반환
