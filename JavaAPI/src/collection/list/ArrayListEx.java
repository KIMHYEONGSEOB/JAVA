...
//		ArrayList<String> list = new ArrayList<>();
		...
		//list의 크기 확인
		System.out.println("리스트 크기: " + list.size()); //length대신 size
		...
		//list에 값이 포함되어 있는지 확인하기 - 문자열, 숫자만 가능
		if(list.contains("html")) {
			System.out.println("html이 포함되어 있음");
		}else {
			System.out.println("html이 없음");
		}
		...
		//제네릭 <?> - 뭐든지 다 들어갈 수 있음
		//제네릭 <? extends String> - String이나, String의 자식타입은 전달 가능
